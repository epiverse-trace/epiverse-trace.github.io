...
**Suggested or ongoing development:** There are several [issues](https://github.com/epiverse-trace/cfr/issues) open that aim to strengthen \{cfr\}, especially for edge cases (e.g. very high CFR) or uncertainty when estimating underascertainment.
