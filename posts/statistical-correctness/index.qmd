...
> Does [@rstudio](https://twitter.com/rstudio?ref_src=twsrc%5Etfw) have a position in the trustworthiness / validity of any ~statistical methods~ packages in [#Rstats](https://twitter.com/hashtag/Rstats?src=hash&amp;ref_src=twsrc%5Etfw)?
>
> Or, is there a list of packages that [@rstudio](https://twitter.com/rstudio?ref_src=twsrc%5Etfw) considers 'approved' and thus will recommend to clients?
> 
