...
knitr::include_graphics('posts/100days-workshop/Scenario1smq.png')
```
<br>
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics('posts/100days-workshop/Scenario2smq.png')
```
<br>
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics('posts/100days-workshop/Scenario3smq.png')
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics('posts/100days-workshop/Scenario4smq.png')
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics('posts/100days-workshop/Scenario5smq.png')
```
