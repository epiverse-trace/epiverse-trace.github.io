...
knitr::include_graphics('posts/Scenario1smq.png')
```
<br>
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics('posts/Scenario2smq.png')
```
<br>
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics('posts/Scenario3smq.png')
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics('posts/Scenario4smq.png')
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics('posts/Scenario5smq.png')
```
