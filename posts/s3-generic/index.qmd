...
author: "Hugo Gruson"
date: "2022-11-18"
categories: [R package, object-orientation, S3, interoperability]
image: "image.jpg"
---
...
The generic should always in the package implementing the actual computation in the function in the first place.
...
[^1]: Every rule has its exceptions though and the [generics](https://generics.r-lib.org/) package, built by prominent members of the R developer community, which overloads base R functions such as `as.factor()` or `as.difftime()`.
...
Alternatively, you can define the method in the package defining the generic. In theory, no `Imports` or `Suggests` is required here:
