...
A peculiarity of R is the availability and centrality of `data.frame`s in the base language, whereas you need extra libraries for a similar functionality in most other languages (e.g., [pandas](https://pandas.pydata.org/) in Python).
...
Overall, these tips on relying on strong parent classes and their existing ecosystems should help produce a package:
