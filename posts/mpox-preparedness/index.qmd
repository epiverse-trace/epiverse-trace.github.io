...
#### Population-level transmissibility ($R0$ and $Rt$)
...
In this post, we have outlined common outbreak analytics tasks relevant to the mpox outbreak, the data required, and R packages/tools that are currently available to facilitate these tasks. The tools described here are developed by the Epiverse-TRACE team and the wider community, following high standards of research software development, and validation from modellers, health professionals, and the user community. The tools are designed to be user-friendly and accessible to a wide range of stakeholders.
