...
date: "2024-06-19"
categories: [R, Epiverse-TRACE, mpox, outbreak, outbreak-analytics, DOI]
...
There is an ongoing outbreak of mpox globally and countries are on the high alert. The Democratic Republic of Congo is so far the worst hit with a total of 7, 851 cases and 384 deaths between January 1 and May 26, 2024 [^1]. Before 2022, there were no reports of sustained mpox outbreaks in most countries of the world. However, within 1 year (Jan 1, 2022, and Jan 29, 2023), 110 countries in all six WHO Regions had reported a total of 85, 473 confirmed cases and 89 deaths [@laurenson2023description].

Mpox is a highly contagious and severe disease that is transmitted through respiratory droplets and direct contact with infected persons. The disease is characterized by fever, cough, and a rash and has an incubation period between 3 - 34 days, depending on the transmission route [@gessain2022monkeypox]. Infected individuals may experience severe symptoms leading to hospitalisation or death. There are two genetic clades: clade I and clade II, which also has subclades IIa and IIb [@laurenson2023description].

Various analyses of the impact of the outbreak at country level are emerging. The US CDC for example has analysed the potential size of outbreaks resulting from transmission within and between households [^2] and the risk of Clade 1 mpox outbreaks among some key populations associated with key transmission routes [^3]. However, the ongoing outbreak will require a coordinated response from the global health community.
...
If we have data on the distribution of sizes of transmission clusters, the [`{epichains}`](https://epiverse-trace.github.io/epichains/) package provides functions to estimate $R0$ and $k$. The user inputs the negative binomial offspring, which assumes individuals exhibit some heterogeneity in transmission. The parameters of the offspring distribution are then estimated using maximum likelihood estimation or a bayesian framework.
...
*Thanks to Karim Mane for his valuable comments on earlier drafts of this post.*
