...
warning function, [bench](https://cran.r-project.org/web/packages/bench/index.html)
for measuring the run times, `dplyr` and `tidyr` for wrangling the results,
...
warnings thrown. Benchmarking experiments with other `cli` functions have revealed linear
...
results of our experiment here. Their benchmarks are available in the cli
documentation [^3].
...
is to demonstrate the utility of benchmarking making quick design decisions.
