...
package[^0]. Quite often, the goal of taking on dependencies is to utilize its
...
execution [^2]. Condition signalling in R is classified into errors,
...
example, when you load a package, R will throw a message to indicate that the
...
[^5]: Dependencies: Mindset and Background: <https://r-pkgs.org/dependencies-mindset-background.html>
[^6]: Donald Knuth's quoted as having said, "The real problem is that programmers have spent far too much time worrying about efficiency in the wrong places and at the wrong times; premature optimization is the root of all evil (or at least most of it) in programming." (See <https://en.wikiquote.org/wiki/Donald_Knuth>)
[^7]: Profiling (Wikipedia): <https://csgillespie.github.io/efficientR/performance.html>
