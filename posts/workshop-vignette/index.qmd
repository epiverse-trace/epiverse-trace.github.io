...
knitr::include_graphics('posts/workshop-vignette/Scenario1smq.png')
```
<br>
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics('posts/workshop-vignette/Scenario2smq.png')
```
<br>
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics('posts/workshop-vignette/Scenario3smq.png')
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics('posts/workshop-vignette/Scenario4smq.png')
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics('posts/workshop-vignette/Scenario5smq.png')
```
