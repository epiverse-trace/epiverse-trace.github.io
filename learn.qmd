...
Our trainings (1) facilitate how to find, choose, and use
R packages for Outbreak Analytics tasks and (2) extending our R toolset
to produce open, reproducible and sustainable data analysis projects
following good Research Sofware practices. These two goals constitute
the **Outbreak Analytics curriculum** and the **Research Sofware
curriculum**.

We address these goals with an e-Epi training kit, Tutorials,
...
Please note the development stage of the learning materials. A
"pre-alpha" tutorial is still being constructed. An
"alpha" tutorial is being taught by the original authors but
...
| Tutorial                                                                                                                              | Repositorio                                                                    | Agenda para instructoras/es                                                                                  | Fase de desarrollo                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [{{< fa regular window-maximize >}} Análisis de Brotes y Modelamiento en Salud Pública](https://epiverse-trace.github.io/epimodelac/) | [{{< fa brands github >}} Repo](https://github.com/epiverse-trace/epimodelac/) | [{{< fa solid person-chalkboard >}} View](https://epiverse-trace.github.io/epimodelac/instructor/index.html) | [![Static Badge](https://img.shields.io/badge/pre-alpha-991b1b)](https://carpentries.github.io/lesson-development-training/lesson-design.html#iterative-development) |

### Tutorials in English

| Tutorial                                                                                                                                                  | Repository                                                                          | Instructor Schedule                                                                                                | Development stage                                                                                                                                                    |
| --------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [{{< fa regular window-maximize >}} Reading and cleaning data for outbreak analytics with R](https://epiverse-trace.github.io/tutorials-early/)           | [{{< fa brands github >}} Repo](https://github.com/epiverse-trace/tutorials-early)  | [{{< fa solid person-chalkboard >}} View](https://epiverse-trace.github.io/tutorials-early/instructor/index.html)  | [![Static Badge](https://img.shields.io/badge/pre-alpha-991b1b)](https://carpentries.github.io/lesson-development-training/lesson-design.html#iterative-development) |
| [{{< fa regular window-maximize >}} Real-time analysis and forecasting for outbreak analytics with R](https://epiverse-trace.github.io/tutorials-middle/) | [{{< fa brands github >}} Repo](https://github.com/epiverse-trace/tutorials-middle) | [{{< fa solid person-chalkboard >}} View](https://epiverse-trace.github.io/tutorials-middle/instructor/index.html) | [![Static Badge](https://img.shields.io/badge/pre-alpha-991b1b)](https://carpentries.github.io/lesson-development-training/lesson-design.html#iterative-development) |
| [{{< fa regular window-maximize >}} Scenario modelling for outbreak analytics with R](https://epiverse-trace.github.io/tutorials-late/)                   | [{{< fa brands github >}} Repo](https://github.com/epiverse-trace/tutorials-late)   | [{{< fa solid person-chalkboard >}} View](https://epiverse-trace.github.io/tutorials-late/instructor/index.html)   | [![Static Badge](https://img.shields.io/badge/pre-alpha-991b1b)](https://carpentries.github.io/lesson-development-training/lesson-design.html#iterative-development) |

### How-to guides in English

| Material                                                                                                                  | Repository                                                               | Instructor schedule | Development stage                                                                                                                                      |
| ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [{{< fa regular window-maximize >}} How-to guides for Outbreak Analytics with R](https://epiverse-trace.github.io/howto/) | [{{< fa brands github >}} Repo](https://github.com/epiverse-trace/howto) | (empty)             | experimental, WIP [https://github.com/epiverse-trace/howto?tab=readme-ov-file#howto](https://github.com/epiverse-trace/howto?tab=readme-ov-file#howto) |
...
| Tutorial                                                                                                                                   | Repository                                                                             | Instructor schedule                                                                                                   | Development stage                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [{{< fa regular window-maximize >}} Version Control with Git in Rstudio](https://epiverse-trace.github.io/git-rstudio-basics/)             | [{{< fa brands github >}} Repo](https://github.com/epiverse-trace/git-rstudio-basics/) | [{{< fa solid person-chalkboard >}} View](https://epiverse-trace.github.io/git-rstudio-basics/instructor/index.html)  | [![Static Badge](https://img.shields.io/badge/alpha-991b1b)](https://carpentries.github.io/lesson-development-training/lesson-design.html#iterative-development)     |
| [{{< fa regular window-maximize >}} Improve your code for Epidemic Analysis with R](https://epiverse-trace.github.io/research-compendium/) | [{{< fa brands github >}} Repo](https://github.com/epiverse-trace/research-compendium) | [{{< fa solid person-chalkboard >}} View](https://epiverse-trace.github.io/research-compendium/instructor/index.html) | [![Static Badge](https://img.shields.io/badge/pre-alpha-991b1b)](https://carpentries.github.io/lesson-development-training/lesson-design.html#iterative-development) |
